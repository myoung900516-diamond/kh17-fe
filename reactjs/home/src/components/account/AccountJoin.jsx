        ...
        <Row className="mt-4">
            ...
            <Col sm={9}>
                <Form.Control type="text" name="accountId"
                    ...
                    onBlur={checkAccountId} className={result.accountId}/>
                    <div className="valid-feedback">아이디 설정이 완료되었습니다</div>
                    <div className="invalid-feedback">형식 오류 또는 사용중입니다</div>
            </Col>
        </Row>
        <Row className="mt-4">
            <Form.Label column sm={3}>
        ...
        <Row className="mt-4">
            ...
            <Col sm={9}>
                <Form.Control type="text" name="accountNickname"
                    ...
                    onBlur={checkAccountNickname} className={result.accountNickname}
                    placeholder="테스트유저"/>
                    <div className="valid-feedback">사용할 수 있는 닉네임입니다</div>
                    <div className="invalid-feedback">닉네임은 특수문자를 제외한 1~10글자입니다</div>
            </Col>
        </Row>
        <Row className="mt-4">
            <Form.Label column sm={3}>
