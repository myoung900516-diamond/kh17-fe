...
export default function KakaopayBuyDetailVersion2() {
    ...
    const [purchase, setPurchase] = useState(null);//대표정보
    ...
    if (purchase === null || details === null || payResponse === null) {
        return (<>
            <Jumbotron title="상품결제상세" content="해당 결제건에 대한 PG사와 연동된 상세 정보입니다." />
    ...
    return (<>
        ...
        <Row className="mt-2">
            ...
            <Col sm={9} className="text-secondary">
                ...
                {/* 10자리 만큼 0을 채워라padStart */}
            </Col>
        </Row>
        <Row className="mt-2">
            <Col sm={3} className="text-info fw-bold">결제 상품명</Col>
            <Col sm={9} className="text-secondary">{purchase.purchaseName}</Col>
        </Row>
        <Row className="mt-2">
            <Col sm={3} className="text-info fw-bold">결제금액</Col>
            <Col sm={9} className="text-secondary">
        ...
        <Row className="mt-2">
            <Col sm={3} className="text-info fw-bold">거래 번호(TID)</Col>
            <Col sm={9} className="text-secondary">
                        ...
                        <ListGroupItem key={detail.purchaseDetailNo} className="p-4">
                            <div className="d-flex">
                                ...
                                <div className="flex-grow-1 ms-2">
                                    ...
                                    <div className="mt-2">
                                        구매수량 : {detail.purchaseDetailQty.toLocaleString()}개
                                    </div>
                                    <div className="mt-2">
                                        구매금액 :
                                    ...
                                    {/* 
                                        취소버튼 등장 조건 
                                        1.해당 상품 구매내역의 현재 상태가 "승인"일것
                                        2. 구매한지 일정 시간이 이내일것 (ex: 7일)
                                    */}
                                    {
