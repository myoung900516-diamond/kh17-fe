...
export default function CountryComplexSearch(){
    ...
    const changeOrder = useCallback((e, index)=>{
        ...
        //같으면 중지
        if(dest === curr) return;
        //(+추가) 같은 항목을 오름차운/내림차순 동시 추가하는 것을 차단
    ...
    return(<>
        ...
        <Row className="mt-4">
            ...
            <hr/>
                <Form.Check type="checkbox" value={"아시아"} label="아시아" onChange={checkCountryRegion} 
                checked={condition.countryRegions.includes("아시아")}/>
                <Form.Check type="checkbox" value={"아프리카"} label="아프리카" onChange={checkCountryRegion} 
                checked={condition.countryRegions.includes("아프리카")}/>
                <Form.Check type="checkbox" value={"북아메리카"} label="북아메리카" onChange={checkCountryRegion} 
                checked={condition.countryRegions.includes("북아메리카")}/>
                <Form.Check type="checkbox" value={"남아메리카"} label="남아메리카" onChange={checkCountryRegion} 
                checked={condition.countryRegions.includes("남아메리카")}/>
                <Form.Check type="checkbox" value={"오세아니아"} label="오세아니아" onChange={checkCountryRegion} 
                checked={condition.countryRegions.includes("오세아니아")}/>
                <Form.Check type="checkbox" value={"유럽"} label="유럽" onChange={checkCountryRegion} 
                checked={condition.countryRegions.includes("유럽")}/>
            </Col>
        </Row>
        <Row className="mt-4">
            <Form.Label column sm={3}>
        ...
        <Row className="mt-4">
            ...
            <Col sm={9}>
                <Form.Select  className="w-auto" name="size" value={condition.size} 
                onChange={changeNumericValue}>
                    <option value={""}>한번에보기</option>
                    ...
                    {/* condition.orders의 내용을 반복적으로 출력 */}
                        ...
                        {condition.orders.map((order, index)=>(
                            ...
                            <div key={index} className="mb-2 d-flex align-items-center">
                                ...
                                <FaXmark className="ms-2 text-danger" 
