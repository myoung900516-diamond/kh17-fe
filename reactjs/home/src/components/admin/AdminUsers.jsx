...
import { FaEraser, FaSearchengin } from "react-icons/fa6";
    ...
    return (<>
        ...
        <Form onSubmit={sendSearch} >
            ...
            <Row className="mt-4">
                ...
                <Col sm={9} className="d-flex">
                    <Form.Check type="checkbox" label="브론즈" value={"브론즈"}></Form.Check>
                    <Form.Check type="checkbox" label="실버" value={"실버"}></Form.Check>
